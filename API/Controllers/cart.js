...
export const addToCart = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error adding product to cart", success: false });
  }
};
...
export const removeFromCart = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error removing product from cart", success: false });
  }
};
...
export const clearCart = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Cart cleared successfully", success: true });
  } catch (error) {
    console.log(error);
...
export const decreaseQuantity = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error decreasing product quantity", success: false });
  }
};
